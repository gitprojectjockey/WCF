...
{
    public class PostalZipCodeManagerServiceHost : ServiceHost
    {
        public PostalZipCodeManagerServiceHost(Type serviceType, params Uri[] baseAddresses) : base(serviceType, baseAddresses) { }
        ...
        protected override void ApplyConfiguration()
        {
            ...
            AddServiceEndpoint(typeof(IPostalZipService), postalServiceBinding, "");
